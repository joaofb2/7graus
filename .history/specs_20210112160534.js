...
describe('Amazon Test', function () {
  ...
  it('O utilizador chega á 1ª página do Pagamento - Direção ', function () {
    ...
    element(by.cssContainingText('option',"Portugal")).click();
   /// address-ui-widgets-countryCode
    element(by.id('address-ui-widgets-enterAddressLine1')).sendKeys("moarada");
    element(by.id('address-ui-widgets-enterAddressLine1')).sendKeys("address-ui-widgets-enterAddressCity");
    element(by.id('address-ui-widgets-enterAddressLine1')).sendKeys("address-ui-widgets-enterAddressPostalCode");
    element(by.id('address-ui-widgets-enterAddressLine1')).sendKeys("address-ui-widgets-enterAddressPhoneNumber");
